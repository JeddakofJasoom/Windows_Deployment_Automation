...
# Install wmic.exe commands - 24H2 deprecates this and is no longer installed by default. We have RMM components and scripts that still use wmic.exe instead of the newer powershell. 
