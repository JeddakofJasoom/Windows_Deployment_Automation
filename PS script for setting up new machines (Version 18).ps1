...
try {
	...
	Write-Host "CRITICAL ERROR: Source folder does not exist: $sourceFolder `n"
				"This source folder MUST exist as '$sourceFolder' on your USB drive to copy over necessary files to the new computer. `n"
