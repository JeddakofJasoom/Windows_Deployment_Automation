...
This section requires installing nuget, which we don't put on client machines yet, so it is commented out. 
There is an option do this in the automation scripts folder on our file share.
